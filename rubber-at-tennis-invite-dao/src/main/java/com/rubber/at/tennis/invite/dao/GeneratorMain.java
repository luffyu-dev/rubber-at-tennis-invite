package com.rubber.at.tennis.invite.dao;
...
public class GeneratorMain extends MybatisBaseCodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        configBean.setJdbcUrl("jdbc:mysql://127.0.0.1:3306/user_db?useUnicode=true;characterEncoding=utf-8");
        ...
        codeGenerator.create("t_user_basic_info");
    }
